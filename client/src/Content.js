...
export const footerNavElements = [
	{ label: 'Twitter', url: '/#', order: '1' },
	{ label: 'Instagram', url: '/#', order: '2' }
];
...
export const portfolioElements = [
	...
	{ title: 'Kcal Kitchen',
		 id: '/kcal-kitchen',
	   type: 'Web',
	   copy: 'Pretium vulputate sapien nec sagittis aliquam malesuada bibendum arcu vitae. Ornare suspendisse sed nisi lacus. Sed risus ultricies tristique nulla aliquet enim tortor at auctor. Odio facilisis mauris sit amet massa vitae tortor condimentum lacinia. Id nibh tortor id aliquet lectus proin nibh nisl. Nec ultrices dui sapien eget mi proin sed libero.',
	 images: [ 
	...
	{ title: 'Niche',
		 id: '/niche',
	   type: 'Web / Branding',
	   copy: 'Nibh venenatis cras sed felis eget velit aliquet sagittis id. Senectus et netus et malesuada fames. Ligula ullamcorper malesuada proin libero nunc consequat interdum varius. Urna nec tincidunt praesent semper feugiat nibh. Commodo elit at imperdiet dui accumsan sit. Vitae congue mauris rhoncus aenean vel elit. Fermentum dui faucibus in ornare quam. Proin sagittis nisl rhoncus mattis rhoncus urna neque. Viverra mauris in aliquam sem fringilla ut morbi tincidunt augue. Id faucibus nisl tincidunt eget nullam non nisi est sit.',
	 images: [
